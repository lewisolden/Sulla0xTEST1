...
export default function DecentralizationSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollPercent > 95) {
        setIsFullyRead(true);
        updateProgress(2, 'decentralization', true);
      }
    };
            ...
            >
              <Card className="bg-green-100 border-l-4 border-green-500 p-4">
                <p className="text-green-700">
                  🎉 Congratulations! You've completed the Decentralization section.
                  You now understand the importance and implications of decentralized systems.
                </p>
              </Card>
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
                ...
                <Link href="/modules/module2/smart-contracts">
                  ...
                  >
                    Next Topic: Smart Contracts <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
              </div>
            </motion.div>
