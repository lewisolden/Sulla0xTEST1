        ...
        <div className="prose lg:prose-xl text-gray-700 space-y-6">
          ...
          >
            <p className="lead">
              ...
              of an agreement when predetermined conditions are met.
            </p>
          </motion.section>
            ...
            >
              <Card className="bg-green-100 border-l-4 border-green-500 p-4">
                <p className="text-green-700">
                  ...
                  You now understand how automated, trustless agreements work on blockchain networks.
                </p>
              </Card>
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
                ...
                <Link href="/modules/module2/applications">
                  ...
                  >
                    Next Topic: Blockchain Applications <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
              </div>
            </motion.div>
