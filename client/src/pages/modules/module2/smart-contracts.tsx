            ...
            >
              <Card className="bg-green-100 border-l-4 border-green-500 p-4">
                <p className="text-green-700">
                  🎉 Congratulations! You've completed the Smart Contracts section and Module 2. 
                  You now understand how smart contracts enable automated, trustless transactions 
                  and power decentralised applications.
                </p>
              </Card>
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
                ...
                <Link href="/modules/module2">
                  ...
                  >
                    Back to Module 2 <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
              </div>
            </motion.div>
