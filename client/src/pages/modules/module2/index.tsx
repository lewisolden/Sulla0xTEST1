...
import { Database, Network, GitFork, Code, Book } from "lucide-react";
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            <p className="text-lg text-gray-700 mb-6">
              ...
              exploring its structure, mechanisms, and applications. Through four comprehensive
              sections, you'll gain a deep understanding of how blockchain works and its
