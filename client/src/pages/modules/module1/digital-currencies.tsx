  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quiz Section within CourseSection */}
        {isFullyRead && (
          <motion.section
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <h2 className="text-3xl font-bold text-blue-700 mb-4">Knowledge Check</h2>
            <DigitalCurrenciesQuiz onComplete={() => {
        ...
        {/* Existing Conclusion and Navigation remains largely the same */}
        {isFullyRead && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
