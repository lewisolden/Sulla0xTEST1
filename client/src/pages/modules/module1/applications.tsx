        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Progress value={scrollProgress} className="w-[100px]" />
            ...
            >
              ...
              <TabsContent value="financial">
                <motion.div variants={itemVariants}>
                  <Card>
                    <CardContent className="prose max-w-none p-6">
                      <h2 className="text-2xl font-bold text-primary">Financial Applications</h2>
              ...
              <TabsContent value="technical">
                <motion.div variants={itemVariants}>
                  <Card>
                    <CardContent className="prose max-w-none p-6">
                      <h2 className="text-2xl font-bold text-primary">Technical Applications</h2>
                      <p className="text-muted-foreground mb-6">
              ...
              <TabsContent value="social">
                <motion.div variants={itemVariants}>
                  <Card>
                    <CardContent className="prose max-w-none p-6">
                      <h2 className="text-2xl font-bold text-primary">Social Impact</h2>
                      <p className="text-muted-foreground mb-6">
          ...
          {isFullyRead && (
            ...
            >
              <Card className="bg-primary/5 border-l-4 border-primary p-4">
