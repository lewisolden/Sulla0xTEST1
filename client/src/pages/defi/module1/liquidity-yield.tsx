...
import { ArrowLeft, ArrowRight, Wallet, RefreshCw, Settings, Info, Check, X, CheckCircle2, Coins, TrendingUp, Lock } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { FaExchangeAlt, FaWater } from "react-icons/fa";
              ...
              <div className="prose max-w-none">
                <section className="mb-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    >
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-semibold">AMM Liquidity</h3>
                      </div>
                      <p className="text-gray-600 mb-4">
                        Automated Market Makers (AMMs) rely on liquidity providers who deposit pairs of tokens into pools. This creates deep markets for traders and generates fees for providers.
                      </p>
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-4">
                        Impermanent loss occurs when the price ratio between paired tokens changes after providing liquidity. Understanding this risk is crucial for liquidity providers.
                      </p>
                      <ul className="space-y-2">
                        <li className="text-sm text-gray-500 flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />
                          Greater price divergence = higher loss
                        </li>
                        <li className="text-sm text-gray-500 flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 mb-8">
                    <h3 className="text-xl font-semibold text-blue-800 mb-4">
                      Key Concepts in Liquidity Provision
                    </h3>
                      ...
                      {[
                        {
                          title: "Pool Tokens",
                          icon: Coins,
                          description: "Represent your share of the liquidity pool"
                        },
                        {
                          title: "Fee Generation",
                          icon: TrendingUp,
                          description: "Earn a portion of trading fees"
                        },
                        {
                          title: "Risk Management",
                          icon: Lock,
                          description: "Balance rewards against impermanent loss"
                        }
                      ].map((concept, index) => (
                        <motion.div
                          key={index}
                        ...
                        >
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h4 className="font-medium text-blue-800">{concept.title}</h4>
                          </div>
                ...
                <section className="mb-12">
                  ...
                  <p className="text-gray-700 mb-6">
                    Experience yield farming with our interactive simulator. See how your liquidity position grows over time with compound interest and rewards.
                  </p>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 rounded-lg p-4 text-sm text-blue-800">
                          <p className="flex items-center gap-2">
                            ...
                            Watch your rewards accumulate in real-time! This simulator uses a simplified model of yield farming mechanics.
                          </p>
                        </div>
                      </div>
                    </div>
