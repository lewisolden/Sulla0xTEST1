  ...
  <Slide key="progress">
    ...
    >
      <div className="flex items-center gap-4 mb-8">
        ...
        <h2 className="text-4xl font-bold text-blue-400">Progress & Technical Capabilities</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <motion.div
          ...
          className="bg-green-100 rounded-lg shadow p-4"
        >
        ...
        <motion.div
          ...
          className="bg-purple-100 rounded-lg shadow p-4"
        >
          <div className="flex items-center mb-2">
        ...
        <motion.div
          ...
          className="bg-indigo-100 rounded-lg shadow p-4"
        >
          <div className="flex items-center mb-2">
        ...
        >
          ...
          <ul className="list-disc pl-6">
            ...
            <li>Blockchain connectivity for NFT certifications</li>
      ...
      <table className="min-w-full bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-lg">
        ...
        <tbody className="divide-y divide-blue-400/30">
          ...
          <tr>
            ...
            <td className="px-4py-3 text-blue-100">$1M</td>
    ...
    <div className="spacey-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-blue-900/30 p-4">
          <h3 className="font-semibold text-blue-30 mb-2">Content Expansion</h3>
          <p className="text-lg text-blue-100">$50K</p>
          <p className="text-sm text-blue-200">Develop additional courses and certifications</p>
        </Card>
        <Card className="bg-blue-900/30 p-4">
          <h3 className="font-semibold text-blue-300mb-2">Marketing & User Acquisition</h3>
          <p className="text-lg text-blue-100">$50K</p>
